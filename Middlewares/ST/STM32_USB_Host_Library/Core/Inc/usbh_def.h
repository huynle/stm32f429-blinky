...
#define LE16(addr)                                                             \
  (((uint16_t)(addr)[0]) | ((uint16_t)(((uint32_t)(addr)[1]) << 8)))

#define LE24(addr)                                                             \
  (((uint32_t)(addr)[0]) | (((uint32_t)(addr)[1]) << 8) |                      \
   (((uint32_t)(addr)[2]) << 16))
...
#define LE64(addr)                                                             \
  (((uint64_t)(addr)[0]) | (((uint64_t)(addr)[1]) << 8) |                      \
...
#define USB_DESC_DEVICE_QUALIFIER                                              \
  ((USB_DESC_TYPE_DEVICE_QUALIFIER << 8) & 0xFF00U)
...
#define USB_DESC_INTERFACE_POWER                                               \
  ((USB_DESC_TYPE_INTERFACE_POWER << 8) & 0xFF00U)
